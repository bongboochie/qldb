                ...
                <tbody>       
                  ...
                  ?>      
                    <tr>
                        ...
                        <td><a href="http://localhost/Danh_Ba_Dien_Tu/admin/qldv-update.php?madv=<?php echo $row['madv'];?>"><i class="bi bi-pencil-square"></i></a></td>
                        <td><a href="http://localhost/Danh_Ba_Dien_Tu/admin/qldv-delete.php?madv=<?php echo $row['madv'];?>"><i class="bi bi-trash"></i></i></a></td>
